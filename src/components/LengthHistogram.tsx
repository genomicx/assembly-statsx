...
export function LengthHistogram({ results, activeIndex: externalIndex }: LengthHistogramProps) {
  ...
  const data = results[idx].histogramBins.map(bin => ({
    name: bin.binLabel,
    count: bin.count,
  }))
  ...
  return (
    <div className="viz-panel">
      <div className="chart-title">Length Distribution</div>
